...
fat_all.depends += good.arm64.dylib good.x86_64.dylib good.ppc64.dylib

fat_no_arm64.target = good.fat.no-arm64.dylib
fat_no_arm64.commands = lipo -create -output $@ -arch x86_64 good.x86_64.dylib -arch ppc64 good.ppc64.dylib
fat_no_arm64.depends += good.x86_64.dylib good.ppc64.dylib

fat_no_x86_64.target = good.fat.no-x86_64.dylib
fat_no_x86_64.commands = lipo -create -output $@ -arch arm64 good.arm64.dylib -arch ppc64 good.ppc64.dylib
fat_no_x86_64.depends += good.arm64.dylib good.ppc64.dylib

fat_stub_arm64.target = good.fat.stub-arm64.dylib
fat_stub_arm64.commands = lipo -create -output $@ -arch ppc64 good.ppc64.dylib
fat_stub_arm64.depends += good.x86_64.dylib good.ppc64.dylib

fat_stub_x86_64.target = good.fat.stub-x86_64.dylib
fat_stub_x86_64.commands = lipo -create -output $@ -arch ppc64 good.ppc64.dylib
fat_stub_x86_64.depends += good.arm64.dylib good.ppc64.dylib
...
MYTARGETS = $$fat_all.depends fat_all fat_no_x86_64 fat_no_arm64 \
            fat_stub_arm64 fat_stub_x86_64 bad
